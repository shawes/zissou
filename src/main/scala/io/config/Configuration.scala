...
case class Configuration(
  ...
  def this() = this(InputFilesConfig("", "", 0),
    ...
    FishConfig(OntogenyConfig(0, 0, 0), SwimmingConfig("", 0,0,0,false,0,0),
...
case class FishConfig(ontogeny: OntogenyConfig,
  ...
  private def this() = this(OntogenyConfig(0, 0, 0), SwimmingConfig("",0,0,0,false,0,0), VerticalMigrationOntogeneticConfig("", new JArrayList[VerticalMigrationOntogeneticProbabilityConfig]),VerticalMigrationDielConfig(new JArrayList[VerticalMigrationDielProbabilityConfig]), PelagicLarvalDurationConfig(0, 0, "", "", 0), false, 0)
}
...
@XmlRootElement
@XmlAccessorType(XmlAccessType.FIELD)
case class SwimmingConfig(ability: String, criticalSwimmingSpeed: Double, inSituSwimmingPotential: Double, endurance: Double, reynoldsEffect: Boolean, ageMaxSpeedReached: Int, hatchSwimmingSpeed: Double) {
  private def this() = this(null, 0, 0, 0, false, 0,0)
}
