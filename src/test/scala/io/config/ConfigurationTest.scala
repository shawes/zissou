...
class ConfigurationTest extends FlatSpec with MockitoSugar {
  ...
  it should "parse the fish node" in {
    ...
    val verticalMigrationPattern = config.fish.verticalMigrationOntogeneticProbabilities.fishVerticalMigrationOntogeneticProbability.get(0)
